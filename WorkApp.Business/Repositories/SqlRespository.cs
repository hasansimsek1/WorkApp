...
using WorkApp.Business.Interfaces;
...
namespace WorkApp.Business.Repositories
{
    public class SqlRespository<T> : IDisposable, ICrudRepository<T> where T : class, IEntity
    {
